...
const PizzaDetails = ({ pizza, modal, setModal }) => {
  ...
  return (
    <div className="flex flex-col overflow-y-scroll scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-white lg:flex-row lg:gap-x-8 z-30 h-full md:p-8">
      ...
      <div className=" flex flex-col flex-1">
        <div className="flex-1 p-2 h-[91%] text-center lg:text-left">
          <div className="flex-1 bg-white md:overflow-y-scroll xl:md:overflow-y-scroll h-full  scrollbar-thin scrollbar-thumb-gray-500 scrollbar-track-white pr-2">
