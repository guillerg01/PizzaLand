...
const Banner = () => {
  return (
    <section className="bg-primary bg-pattern lg:min-h-[768px] lg:pt-16">
      <div className="container mx-auto min-h-[768px] flex items-center justify-center">
        <MouseParallaxContainer
          globalFactorX={0.4}
          globalFactorY={0.3}
          resetOnLeave
          className="w-full flex mt-20 md:mt-20 lg:mt-0 xl:mt-0 flex-col lg:flex-row justify-between items-center"
        >
          <MouseParallaxChild factorX={0.1} factorY={0.2}>
            <div className="flex flex-col lg:flex-row items-center lg:text-left flex-1 px-6 text-white">
              <div className="flex-1">
                <div className="font-bangers text-center text-[32px] text-white uppercase tracking-[0.03em]">
                  Best pizza in town
                </div>
                <h1 className="text-6xl lg:text-8xl text-center font-bangers drop-shadow-md">
                  Pizza perfection <br></br> in every bite
                </h1>
              </div>
            </div>
          </MouseParallaxChild>
